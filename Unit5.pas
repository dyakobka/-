...
stringgrid1.Cells[2,0]:='Набор';
stringgrid1.Cells[3,0]:='Выпуск';
stringgrid1.Cells[4,0]:='Студентов';
stringgrid1.Cells[5,0]:='Курс';
...
stringgrid2.Cells[1,0]:='Фамилия Имя Отчество';
...
stringgrid1.Cells[4,0]:='Дисциплина';
stringgrid1.Cells[5,0]:='ЗЕТ';
stringgrid1.Cells[6,0]:='Преподаватель';
stringgrid1.Cells[7,0]:='Код протокола';
panel1.Caption:='';
end;
...
label50.Caption:='Осенний';
end else
begin
label48.Caption:=inttostr(t3-1)+''+inttostr(t3);
label51.Caption:='Весенний';
end;
end;
end;
