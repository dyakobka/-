...
stringgrid1.Cells[1,0]:='Фамилия Имя Отчество студента';
stringgrid1.Cells[2,0]:='№ зачетной книжки';
...
stringgrid2.Cells[1,0]:='Наименование темы (подтемы)';
stringgrid2.Cells[2,0]:='Домашняя работа';
stringgrid2.Cells[3,0]:='Материалы';
stringgrid2.Cells[4,0]:='Презентация';
stringgrid2.Cells[5,0]:='Видео';
stringgrid2.Cells[6,0]:='Код занятия';
...
stringgrid3.Cells[2,0]:='Фамилия Имя Отчество студента';
stringgrid3.Cells[3,0]:='Дисциплина';
stringgrid3.Cells[4,0]:='Тип';
stringgrid3.Cells[5,0]:='Попытка';
stringgrid3.Cells[6,0]:='Заявка';
stringgrid3.Cells[7,0]:='Начало';
stringgrid3.Cells[8,0]:='Окончание';
stringgrid3.Cells[9,0]:='Пересдача';
stringgrid3.Cells[10,0]:='Результат';
stringgrid3.Cells[11,0]:='Код протокола';
...
if dm.Q1.Eof=true then
  ...
  speedbutton1.Caption:='Редактировать';
  ...
  label10.Caption:='Контрольный лист промежуточной и итоговой аттестации';
  dm.Q2.Close;
  dm.Q2.SQL.Clear;
  ...
  if dm.Q2.Eof=false then
    ...
    if dm.Q2.Eof=false then
      ...
      label20.Caption:=dm.Q1.fieldbyname('Date_Prot').AsString;
            ...
            1: label22.Caption:='экзамен';
            2: label22.Caption:='зачет';
            3: label22.Caption:='зачет с оценкой';
            end;
          end;
        end;
...
if dm.Q1.Eof=false then
  ...
  combobox2.Items.Add('Осенний');
  combobox2.Items.Add('Весенний');
  end;
end;
...
if (panel1.Visible=true) and (combobox2.ItemIndex>-1) then
  ...
  begin
  //будет продолжение программного кода
  end;
end;
        ...
        if dm.Q4.Eof=false then
          ...
          if dm.Q3.Eof=false then
            ...
            stringgrid3.Cells[4,j]:=dm.Q3.fieldbyname('Names').AsString;
              ...
              1: stringgrid3.Cells[5,j]:='экзамен';
              2: stringgrid3.Cells[5,j]:='зачет';
              3: stringgrid3.Cells[5,j]:='зачет с оценкой';
              end;
...
begin
if speedbutton1.Caption='Редактировать' then
  begin
  ...
  for j:=1 to stringgrid3.RowCount-1 do
    ...
    if stringgrid3.Cells[11, j]='' then
      ...
      begin
      if stringgrid3.Cells[5,j]='экзамен'         then tc1:=1;
      if stringgrid3.Cells[5,j]='зачет'           then tc1:=2;
      if stringgrid3.Cells[5,j]='зачет с оценкой' then tc1:=3;
      st1:=stringgrid3.Cells[10,j];
